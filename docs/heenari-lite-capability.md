...
- 예약 가능 시간: 00:00–24:00 (새벽 포함 하루 전체, 2026-09-24 사용자 요청. 이전 09:00–24:00)
- 최소 예약: 30분
...
가장 이른 것)를 보여주고, 그 아래에 내 다음 동아리방 시간을 둔다(2026-09-24, FB-05).
동아리 공지 기능은 두지 않는다(2026-09-24 만들었다가 사용자 요청으로 삭제). 일정 화면은
...
- 회비, 예산, 영수증, 회계
- 행사 참가 신청과 출석 체크
- 이메일, 문자 알림 (푸시는 FB-04에서 합주 초대·1시간 전 알림만 범위에 넣음, 2026-09-23 사용자 결정)
- 채팅과 댓글
- 파일 및 이미지 업로드
- 실시간 접속 상태 표시
- 복잡한 통계와 대시보드
