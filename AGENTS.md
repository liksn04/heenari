...
- `docs/gates/HEENARI-FB-05-HOME-JAM-NOTICES.md`: 현재 활성 구현 게이트(홈 다음 합주)
...
현재 활성 게이트는 `HEENARI-FB-05 홈 다음 합주` 하나다. 동아리 공지 기능은 두지 않는다
(2026-09-24 삭제). 알림 발송은 Cloudflare Worker(`notifier/`)가
